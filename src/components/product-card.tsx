    ...
    <>
      ...
      >
        <div className="relative block aspect-square overflow-hidden bg-surface">
          ...
          <div className="absolute inset-x-0 bottom-3 z-10 flex justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100 px-3">
            <Button
              size="sm"
              variant="secondary"
        ...
        <button
          ...
          className="absolute right-3 top-3 z-20 grid h-9 w-9 place-items-center rounded-full border border-border bg-background/85 backdrop-blur transition-colors hover:bg-background shadow-sm"
        >
          <Heart
        ...
        <div className="flex flex-1 flex-col gap-2 p-4">
          ...
          <Link to="/product/$slug" params={{ slug: product.slug }} className="min-w-0">
            <h3 className="font-display text-base leading-snug text-foreground hover:text-primary transition-colors">
              {product.name}
            </h3>
          </Link>
          ...
          <div className="mt-auto flex items-end justify-between gap-3 pt-2">
            ...
            <Button
              ...
              className="shrink-0 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground font-medium px-4 shadow-sm"
            >
